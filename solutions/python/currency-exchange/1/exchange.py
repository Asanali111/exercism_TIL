...
def get_number_of_bills(amount, denomination):
    ...
    num_of_bills = int(amount/denomination)
    return num_of_bills
...
def get_leftover_of_bills(amount, denomination):
    ...
    leftover_bills = amount - denomination*int(amount/denomination)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    logic: budget/ exchange rate + spread %  but by the denominationed bills
    """

    gross_exhcanged_value = budget/(exchange_rate + exchange_rate*spread/100)
    billed_exchange_value = int(gross_exhcanged_value/denomination)*denomination
    return billed_exchange_value